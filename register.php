...
<form name="miformulario" onsubmit="verificarPasswords(); return false" action="ValidaRegister.php" method="post">    	
...
-->        
        ...
        <div class="form-group" >
        	    <a class="btn btn-danger" href="login.php" class="form-control">Ya Poseo Una Cuenta
    </a>
          <button type="submit" id="login" class="btn btn-primary pull-right">Registrar</button>
        </div>
