...
?>
    ...
    <tr>
    <td>Carnet</td> 
          <td><input type="text" maxlength="10" size="10" name="carnet" value="<?php if(is_numeric($value["numcarnet"])) {echo $value["numcarnet"]; } else { echo "Debe ser numérico"; } ?> " required></td>
    </tr>
<!--    <tr>
    <td>Categoría</td> 
          <td style="color: red">
