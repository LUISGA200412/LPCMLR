...
$sql = "SELECT * FROM equipo 
		where idequipo = $idequipo and tipo_torneo=2  ";
...
$jug=0;
$sql = "SELECT count(*) as jugada FROM lineas where idequipo = $idequipo and tipo_torneo = 2 and fecha_linea='$fechacarga'  ";
$result=mysqli_query($mysqli,$sql); 
while($mostrar=mysqli_fetch_array($result))
{
	$jug = $mostrar['jugada'];
...
echo "<script>
alert(
	'Equipo ya tiene lineas Cargadas para la fecha $fechacarga dirijase al Modulo Modificar Lineas');
...
<form action="IncluirLineasParejas.php" method="POST"> 	
...
<div>
  <h2>
    <a href="CargarLineasParejas.php"> 
