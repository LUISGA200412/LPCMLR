...
sum(score) as SUMATOTAL, `ced_jugador`, idequipo from `lineas` where  sexo = 1 and score > 0 and  idtorneo = $idtorneo group by `ced_jugador` order by avg(score) DESC";
...
<caption class="text-center">
	...
	<strong><font color="black">Individual Masculino</font></strong><br>
...
*/
		...
		`ced_jugador`=$cedula and sexo = 1  and idtorneo = $idtorneo order by fecha_linea, idlineas";
		echo "<tr>";	
