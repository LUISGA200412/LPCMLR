...
//	score > 0 and
		...
		if ($jugadas < 20) 
		{
			...
			{ 
				echo "<td style='vertical-align:middle' align='center'></td>";
		
			}
			echo "<td style='vertical-align:middle' align='center'>$suma</td>";
...
echo "<th class='hidden-xs text-center' ><b>$totalequipo</b></th>";
echo "<th class='hidden-xs text-center' >";
		echo "<strong>";
