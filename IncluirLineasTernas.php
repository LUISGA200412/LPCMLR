		...
		while($rows1 = $resultado1->fetch_assoc())
		{
	 	...
	 	{ 
			...
			//{
				...
				$sql = "INSERT INTO `lineas`(`idpais`, `idciudad`, `idbolera`, `idtorneo`, `idcategoria`, `idsubcategoria`, `ced_jugador`, `idlineas`, `final`, `sexo`, `score`, `num_cancha`, `fecha_linea`, `idequipo`, `tipo_torneo`, `num_linea_fecha`)
...
alert(
	...
	location.href ='CargarLineasTernas.php';
	</script>";
