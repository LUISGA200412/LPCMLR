...
$jug=0;
$sql = "SELECT count(*) as jugada FROM lineas where idequipo = $idequipo  and tipo_torneo = 2 and fecha_linea='$fechalinea'  ";
$result=mysqli_query($mysqli,$sql); 
while($mostrar=mysqli_fetch_array($result))
{
	$jug = $mostrar['jugada'];
...
<form action="ModificarLineasParejasDatos.php" method="POST"> 	
...
$sql11 = "SELECT count(*) as jugada FROM lineas where idequipo = $idequipo and tipo_torneo = 2  and fecha_linea = '$fechalinea' GROUP by ced_jugador  ";
...
<div>
  <h2>
    <a href="ModificarLineasParejas.php"> 
