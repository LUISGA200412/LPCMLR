...
$sihay=0;
$sql1 = "SELECT count(*) as SIHAY FROM torneo where status_torneo = 1 and tipo_torneo = 2 order by idtorneo DESC LIMIT 1";
...
location.href ='PerfilAdministrador.php';
	...
	$sql1 = "SELECT * FROM torneo where status_torneo = 1 and tipo_torneo = 2 order by idtorneo 
			DESC LIMIT 1";
	$resultado1 = $mysqli->query($sql1);
	while($rows1 = $resultado1->fetch_assoc())
	{
...
<form name="miformulario" onsubmit="verificarPasswords(); return false" action="ModificarLineasParejasJugadores.php" method="POST"> 
	...
	<tr>
		<td align="center">
		 ...
		 <option   value="">Seleccione La Fecha</option> 
		    ...
		    $sql1="SELECT fecha_linea FROM `lineas` where tipo_torneo = 2 group by fecha_linea";
		 ...
		 <option   value="">Seleccione El Equipo</option> 
		    ...
		    $sql1="SELECT * FROM equipo where tipo_torneo = 2 order by idequipo ";
		    $result1=mysqli_query($mysqli,$sql1); 
		    while($mostrar1=mysqli_fetch_array($result1))
		    {
