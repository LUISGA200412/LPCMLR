...
<div style="margin-left:650px;">
  <h2>
    <a href="ActualizaJugadores.php"><b>Liga Picapiedras CMLR</b>
    	<br>
        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
              <?php
			   ...
			   ?>
			   <!-- Profile Name -->
              <h3 class="profile-username text-center"><?php echo utf8_decode($nombre); ?></h3>
...
<div class="row">
    <div class="col-md-8">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="#datos" data-toggle="tab">Datos Personales</a></li>
				<!--<li>
				<a href="#foto" data-toggle="tab">Cargar Foto</a>
				</li>
     			<li>
     			<a href="#otros" data-toggle="tab">Datos FVB</a>
     			</li>
     			<li><a href="#activi" data-toggle="tab">Data Curricular</a>
     			</li>-->      
            </ul>
        ...
        <div class="tab-content">
                ...
                <form class="form-horizontal" action="ActualizaDatosPersonalesAdministrador.php?cedula=<?php echo $cedula; ?>" method="post">
                	<br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input required type="text" class="form-control" id="inputName" placeholder="Nombre y Apellido" value="<?php echo utf8_decode($nombre);?>" name="nombre">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input required type="text" class="form-control" id="inputName" placeholder="Direccion" value="<?php echo $direccion;?>" name="direccion">
                    </div>
                  </div>
                  <div class="form-group">
