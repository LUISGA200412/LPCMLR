...
$sql = "SELECT * FROM equipo 
		where idequipo = $idequipo and tipo_torneo=3  ";
...
$jug=0;
$sql = "SELECT count(*) as jugada FROM lineas where idequipo = $idequipo and fecha_linea='$fechacarga'  ";
$result=mysqli_query($mysqli,$sql); 
while($mostrar=mysqli_fetch_array($result))
{
	$jug = $mostrar['jugada'];
...
<form action="IncluirLineasTernas.php" method="POST"> 	
